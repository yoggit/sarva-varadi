...
<div class="sv-view" id="sv-section-overview" data-view="overview" style="display:block;">
  ...
  <div id="sv-newly-failing-section" style="display:none;margin-top:1.25rem;"></div>
  ...
  <!-- Bottom row: Top Failures + Top Flaky — align-items:start prevents height stretching -->
    ...
    <div class="sv-card" id="sv-top-failures-card">
      <div class="sv-card-header">
        ...
        <span style="display:flex;align-items:center;gap:0.4rem;">
          ...
          <button class="sv-dl-btn" onclick="SarvaOverview.downloadFailuresCsv()" data-sv-tip="Download as CSV">${CSV_ICON}</button>
        </span>
      </div>
    ...
    <div class="sv-card" id="sv-top-flaky-card">
      <div class="sv-card-header">
        ...
        <span style="display:flex;align-items:center;gap:0.4rem;">
          ...
          <button class="sv-dl-btn" onclick="SarvaOverview.downloadFlakyCsv()" data-sv-tip="Download as CSV">${CSV_ICON}</button>
        </span>
      </div>
